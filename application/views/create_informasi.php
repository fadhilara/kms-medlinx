...
<div class="container">
  ...
  <ul class="navbar-nav">
   ...
   <li class="nav-item">
    ...
    <div class="card-header text-center">Create Informasi</div>
    <div class="card-body">
     <form method="post" action="<?php echo base_url(). 'informasi/create_aksi'; ?>">
    <div class="form-group">
      <label for="Judul Informasi">Judul Informasi :</label>
      <input type="text" class="form-control" placeholder="Judul Informasi" name="judul_informasi">
    </div>
    <div class="form-group">
      <label for="Isi Informasi">Isi Informasi :</label>
      <textarea class="form-control" rows="3" name="isi_informasi"></textarea>
    </div>
    <div class="form-group">
      <label for="Diposting Oleh">Diposting Oleh :</label>
      <input type="text" class="form-control" placeholder="Diposting Oleh" name="diposting_oleh">
    </div>
    <div class="form-group">
