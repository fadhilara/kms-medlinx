  ...
  <ul class="navbar-nav">
   ...
   <li class="nav-item">
    ...
    <div class="card-body">
       <div class="col">
          <div class="row">
            <div class="col-6"><a href=" <?php  echo base_url().'informasi/create'?>" class="btn btn-primary pull-right" style="margin-bottom: 15px"> Create Informasi   </a></div>
            <div class="col-6"><div class="input-group">
    <input type="text" class="form-control" placeholder="Search by judul informasi">
    ...
    <table class="table table-bordered">
      ...
      <tbody>
        <tr>
          ...
          <td><?php  echo $u->isi_informasi;  ?></td>
          <td><?php   echo $u->diposting_oleh; ?></td>
          <td><?php   echo $u->tanggal_posting; ?></td>
          <td><?php   echo $u->waktu_posting; ?></td>
          <td><a href="<?php  echo base_url().'informasi/edit/'.$u->id_informasi;?>" class="btn btn-warning">Edit</a> </td>
          <td><a href="<?php  echo base_url().'informasi/delete/'.$u->id_informasi; ?>" class="btn btn-danger">Delete</a> </td>
