...
<div class="container">
  ...
  <ul class="navbar-nav">
   ...
   <li class="nav-item">
    ...
    <div class="card-header text-center">Create Issue</div>
    <div class="card-body">
     <form method="post" action="<?php echo base_url(). 'issue/create_aksi'; ?>">
    <div class="form-group">
      <label for="Jenis Rapat">Nama Issue :</label>
      <input type="text" class="form-control" placeholder="Nama Issue" name="nama_issue">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <textarea class="form-control" rows="3" name="permasalahan" ></textarea>
    </div>
    <div class="form-group">
      <label for="Solusi">Solusi :</label>
      <textarea class="form-control" rows="3" name="solusi"></textarea>
    </div>
    <div class="form-group">
      <label for="Created by">Dibuat oleh :</label>
      <input type="text" class="form-control" placeholder="Dibuat oleh" name="dibuat_oleh">
    </div>
    <div class="form-group">
